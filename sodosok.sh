...
cd /usr/bin
wget -O addss "https://raw.githubusercontent.com/irwanmohi/aidan-vpn//main/addss.sh"
wget -O delss "https://raw.githubusercontent.com/irwanmohi/aidan-vpn//main/delss.sh"
wget -O cekss "https://raw.githubusercontent.com/irwanmohi/aidan-vpn//main/cekss.sh"
wget -O xp-ss "https://raw.githubusercontent.com/irwanmohi/aidan-vpn//main/xp-ss.sh"
wget -O renewss "https://raw.githubusercontent.com/irwanmohi/aidan-vpn//main/renewss.sh"
chmod +x addss
chmod +x delss
chmod +x cekss
chmod +x xp-ss
